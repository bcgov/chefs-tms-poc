...
export class Initial1739571409289 implements MigrationInterface {
    name = 'Initial1739571409289'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Role" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(100) NOT NULL, "description" character varying(255), "created_datetime" TIMESTAMP NOT NULL DEFAULT now(), "updated_datetime" TIMESTAMP NOT NULL DEFAULT now(), "tenant_id" uuid, CONSTRAINT "UQ_b852abd9e268a63287bc815aab6" UNIQUE ("name"), CONSTRAINT "PK_9309532197a7397548e341e5536" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "Tenant" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(30) NOT NULL, "ministry_name" character varying(100) NOT NULL, "created_datetime" TIMESTAMP NOT NULL DEFAULT now(), "updated_datetime" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_cebe9e163fad8d1d82343a48fba" UNIQUE ("name"), CONSTRAINT "UQ_557fb6d856ee7faf540c425a224" UNIQUE ("ministry_name"), CONSTRAINT "PK_9ba54ddd56ce80e5b2d7523b6be" PRIMARY KEY ("id"))`);
